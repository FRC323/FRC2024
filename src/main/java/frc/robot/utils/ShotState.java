...
public class ShotState {
  ...
  private static InterpolatingDoubleTreeMap initializeInterpolator() {
    ...
    armAngleInterpolation.put(1.5, -0.35);
    armAngleInterpolation.put(2.0, -0.51);
    armAngleInterpolation.put(2.5, -0.625);
    armAngleInterpolation.put(3.0,-0.69);
    armAngleInterpolation.put(3.5, -0.72);

    armAngleInterpolation.put(4.0, -0.78);

    armAngleInterpolation.put(4.5, -0.8);
